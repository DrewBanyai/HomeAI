...
from Helper import GetNewsTopHeadlines, SendTestEmail, GetCryptoPrices, IsGmailLoginDefined, log_debug_message
...
def ExecuteCommand(command, speechCallback, alarmCallback):
    ...
    partialCheck = PartialCommandCheck(command)
...
def PartialCommandCheck(command):
    try:
        details = ""
